...
from mmtools import mmtiff, spotselector, spotmarker, spotplotter

# prepare spot marker
marker = spotmarker.SpotMarker()
selector = spotselector.SpotSelector()
...
parser.add_argument('-m', '--mask-image', nargs=1, default = [mask_filename], \
...
mask_filename = args.mask_image[0]
...
if mask_filename is not None:
    ...
    spot_table = selector.filter_spots_maskimage(spot_table, mask_image)
...
image_color = marker.mark_spots(output_image, spot_table)
